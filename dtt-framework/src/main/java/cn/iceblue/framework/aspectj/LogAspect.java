package cn.iceblue.framework.aspectj;

import cn.dev33.satoken.stp.StpUtil;
import cn.iceblue.core.annotation.Log;
import cn.iceblue.core.domain.enums.dict.BooleanDict;
import cn.iceblue.core.filter.PropertyPreExcludeFilter;
import cn.iceblue.core.pojo.entity.SysOperLogEntity;
import cn.iceblue.core.util.CollectionUtils;
...
public class LogAspect {
    ...
    protected void handleLog(final JoinPoint joinPoint, Log controllerLog, final Exception e, Object jsonResult) {
        try {
            ...
            operLog.setStatus(BooleanDict.SUCCESS.getCode());
            // 请求的地址
            ...
            if (e != null) {
                operLog.setStatus(BooleanDict.FAIL.getCode());
                operLog.setErrorMsg(StringUtils.substring(Convert.toStr(e.getMessage(), "默认异常"), 0, 2000));
            }
            // 设置方法名称
            ...
            // 设置消耗时间
            operLog.setCostTime((int) (System.currentTimeMillis() - TIME_THREADLOCAL.get()));
            // 保存数据库
